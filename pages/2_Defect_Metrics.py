...
st.set_page_config(page_title="Defect Metrics", page_icon="🐛", layout="wide")
init_session_state()
render_global_filters()
...
with right:
    ...
    # Normalize priority labels for consistent ordering
...
if mttr.empty:
    st.info("Not enough closed defects with both created and closed dates to compute MTTR.")
else:
    mttr_view = mttr.copy()
